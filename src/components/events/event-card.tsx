...
export function EventCard({ event: e }: { event: GostosoEvent }) {
  ...
  return (
    <article className="bg-white rounded-2xl border border-[#E8E4DF] overflow-hidden hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
      <div className="aspect-[16/7] bg-gradient-to-br from-teal to-teal-dark relative">
      ...
      <div className="p-5">
        ...
        {e.source_url && (
          <a href={e.source_url} target="_blank" rel="noopener noreferrer" className="mt-3 inline-block text-teal text-sm font-semibold">
            Saiba mais →
          </a>
        )}
      </div>
